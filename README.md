...
This project implements each step of the RAG pipeline explicitly: chunking strategy, embedding model 
selection, vector storage, retrieval, and prompt construction.
